...
import SendConsoleLogWhenCustomerChangedAddressHandler from "../../customer/event/handler/send-console-log-when-customer-change-address";
import SendConsoleLog1WhenCustomerIsCreatedHandler from "../../customer/event/handler/send-console-log1-when-customer-is-created";
import SendConsoleLog2WhenCustomerIsCreatedHandler from "../../customer/event/handler/send-console-log2-when-customer-is-created";
